...
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role`(`ID`,`ROLE_NAME`,`REMARK`) VALUES ('1', '管理员', '管理员');
INSERT INTO `t_role`(`ID`,`ROLE_NAME`,`REMARK`) VALUES ('2', '注册用户', '可查看，新增，导出');
INSERT INTO `t_role`(`ID`,`ROLE_NAME`,`REMARK`) VALUES ('3', '普通用户', '只可查看，好可怜哦');
