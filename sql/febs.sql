...
insert into t_app (`APP_NAME`,`STATUS`)values('auth权限系统', '1');
...
-- Records of t_menu
-- ----------------------------
INSERT INTO `t_menu`(`ID`,`PARENT_ID`, `MENU_NAME`, `PATH`,`COMPONENT`,`PERMS`,`ICON`,`TYPE`,`ORDER_NUM`,`APP_ID`)
...
-- Records of t_role
-- ----------------------------
INSERT INTO `t_role`(`ID`,`ROLE_NAME`,`REMARK`,`APP_ID`) VALUES ('1', '管理员', '管理员','1');
INSERT INTO `t_role`(`ID`,`ROLE_NAME`,`REMARK`,`APP_ID`) VALUES ('2', '注册用户', '可查看，新增，导出','1');
INSERT INTO `t_role`(`ID`,`ROLE_NAME`,`REMARK`,`APP_ID`) VALUES ('3', '普通用户', '只可查看，好可怜哦','1');
